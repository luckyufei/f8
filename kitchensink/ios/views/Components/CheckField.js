import { Page, TransitionPages, Navbar, Form, CheckField } from 'jmui'
...
export default class CheckFieldView extends Component {
  ...
  render () {
    ...
    return (
      ...
      />}>
        <Form title='单行文字的多选'>
          <CheckField onClick={::this.handleSpecial.bind(this, 1)} name='special' value={1} title='年少' check={special.indexOf(1) > -1} />
          <CheckField onClick={::this.handleSpecial.bind(this, 2)} name='special' value={2} title='多金' check={special.indexOf(2) > -1} />
          <CheckField onClick={::this.handleSpecial.bind(this, 3)} name='special' value={3} title='帅气' check={special.indexOf(3) > -1} />
          <CheckField onClick={::this.handleSpecial.bind(this, 4)} name='special' value={4} title='风流' check={special.indexOf(4) > -1} />
          <CheckField onClick={::this.handleSpecial.bind(this, 5)} name='special' value={5} title='颓废' check={special.indexOf(5) > -1} after='这是我' />
        </Form>
        <Form title='多行内容的多选' multiLine>
          <CheckField
